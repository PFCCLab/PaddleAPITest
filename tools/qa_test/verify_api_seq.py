...
MOE_MARKERS = (
    'moe_permute', 'moe_unpermute', 'fp8_quant',
    'fused_act_dequant', 'fused_linear', '_run_custom_op', 'swiglu',
)
...
def report(name, derived_lines, real_lines):
    ...
    print(f"  {name:<14}: {inter}/{denom} = {pct:.2f}%  "
...
def parse_args():
    ...
    parser.add_argument("-d", "--derived", required=True,
                        help="推导的配置文件路径")
