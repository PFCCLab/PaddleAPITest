...
# paddle.var(Tensor([205923],"float64"), k=1, axis=0, )

m = 38400000
# n = 205923
test_loop = 10215
numpy_tensor = (numpy.random.random([m]) - 0.5).astype("float64")
...
numpy_tensor = (numpy.random.random(paddle_out.shape) - 0.5).astype("float64")
